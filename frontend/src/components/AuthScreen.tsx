...
export function AuthScreen({
  ...
  return (
    <div className="w-full max-w-md mt-16 flex flex-col space-y-6 anonymity-guard animate-[fadeIn_0.2s_ease-out]">
      {/* 🌟 НОВИЙ ОЧИЩЕНИЙ ХЕДЕР: Ідентичний внутрішньому стилю додатка! */}
      <header className="flex flex-col items-center text-center space-y-2.5">
        ...
        <p className="text-slate-400 text-xs font-medium pt-0.5">
          Вхід у твій персональний хмарний блокнот
        </p>
      </header>

      {/* КАРТКА ФОРМИ (Твій чистий код Font Awesome) */}
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wide flex items-center gap-1.5">
              <i className="fa-solid fa-envelope text-slate-400"></i> Електронна
              пошта
            </label>
            <input
              type="email"
