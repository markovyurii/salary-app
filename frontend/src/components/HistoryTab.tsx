          ...
          {list.map((day) => {
            ...
            const dayItems = [
              ...
              },
              {
                ...
                label: 'Підключення з ТВ на двох (75 грн)',
                icon: 'fa-network-wired',
                color: 'text-emerald-400',
              },
              {
                val: day?.connect_internet_solo,
                label: 'Підключення  інтернет (100 грн)',
                icon: 'fa-globe',
                color: 'text-teal-400',
              },
              {
                val: day?.connect_internet_shared,
                label: 'Підключення  інтернет на двох (50 грн)',
                icon: 'fa-people-arrows',
                color: 'text-teal-500',
              },
              {
                val: day?.connect_tv_solo,
                label: 'Підключення телебачення (100 грн)',
                icon: 'fa-tv',
                color: 'text-sky-400',
              },
              {
                val: day?.connect_tv_shared,
                label: 'Телебачення на двох (50 грн)',
                icon: 'fa-users',
                color: 'text-sky-400',
              },
              {
              ...
              },
              {
                ...
                label: 'Допідкл. ПОН (100 грн)',
                icon: 'fa-bolt',
                color: 'text-indigo-400',
              },
              {
                val: day?.addon_pon_shared,
                label: 'Допідкл. ПОН на двох (50 грн)',
